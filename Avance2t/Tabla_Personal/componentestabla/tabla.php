...
<div class="row">
	<div class="col-sm-12 table-responsive">
		<table class="table table-hover table-condensed table-bordered">
			...
			<tr>
				...
				<td>
					<button class="btn btn-danger glyphicon glyphicon-remove" onclick="preguntarSiNo()"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-x-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/><path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg>
				    </button>
				</td>
			</tr>
			<?php 
	...
	<script>
		function preguntarSiNo(){
			alertify.confirm('Eliminar personal', '¿Esta seguro de eliminar este usuario?', function(){ alertify.success('Actualizado con exito') }
            , function(){ alertify.error('Sin cambios realizados')});
		}
	</script>
